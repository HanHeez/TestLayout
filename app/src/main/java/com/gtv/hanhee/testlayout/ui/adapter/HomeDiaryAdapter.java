...
public class HomeDiaryAdapter extends BaseSectionQuickAdapter<ProductSection, BaseViewHolder> {
    ...
    public HomeDiaryAdapter(Activity activity, List<ProductSection> data, OnItemRvClickListener onItemRvClickListener) {
