...
public class CustomBanner extends Banner implements ViewPager.OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.custom_product_detail_banner;
    ...
    public CustomBanner setData(List<Product> productList) {
        this.recommendProductList = productList;
        this.count = (int) Math.ceil(productList.size() / 6);
        return this;
    }
